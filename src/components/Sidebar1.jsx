...
function Sidebar(){
    ...
    return(
        <Box  height={`${windowHeight}px`}  flex={0.1} bgcolor={"#fff"} borderRight={"2px solid #ede5e5"}  sx={{ display:{xs:"block", sm:"block"}}}>
    {/* <Box position="fixed"> */}
    <List disableFocusOnHover component="nav"	>
          ...
          <ListItem disablePadding > 
            <ListItemButton component={Link} href="/BarsDataset"
