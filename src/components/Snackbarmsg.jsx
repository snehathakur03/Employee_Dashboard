        ...
        message={
          <div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <Icon><CampaignOutlined sx={{color:"#556ee6"}} /></Icon>
              <Typography variant="body1" sx={{ fontSize: "13px", fontWeight: "600", marginLeft: "10px", color:"#556ee6" }}>
                Work from home - Covid 19
              </Typography>
            </div>
            <Typography  sx={{ fontSize: "13px", fontWeight: "500", marginTop: "12px", color:"#a8acb8" }}>
...
{openSecond && (
  <Snackbar 
    ...
    message={
      <Stack direction="row">
        <Icon flex={2}><WorkHistoryOutlined sx={{color:"#556ee6"}} /></Icon>
        <Typography flex={8} variant="body1" sx={{ fontSize: "13px", fontWeight: "600", marginLeft: "10px", color:"#556ee6" }}>
          Today is Jenny Wilson's 3rd work anniversary
        </Typography>
      </Stack>
    }
    action={ // Make sure to close the IconButton component properly
      <IconButton
        size="small"
        aria-label="close"
        color="inherit"
